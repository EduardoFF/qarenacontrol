/*
 * TrackerToRobot is part of QArenaControl, and is Copyright 2013-2014,
 * Eduardo Feo <eduardo@idsia.ch.
 *
 ...
 * along with QArenaControl.  If not, see <http://www.gnu.org/licenses/>.
 */
...
void processFrames(FrameListener& frameListener)
{
   bool valid;
   MocapFrame frame;
   Globals::run = true;
