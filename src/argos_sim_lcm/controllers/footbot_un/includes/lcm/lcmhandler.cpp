...
void LCMHandler::handleMessage(const lcm::ReceiveBuffer* rbuf, const std::string& chan, const poselcm::pose_list_t* msg) {
	...
	for (int i = 0; i < msg->n; i++) {
		...
		// Orientation
		orientations = CQuaternion(pose.orientation[0]/1000.0f, pose.orientation[1]/1000.0f, pose.orientation[2]/1000.0f, pose.orientation[3]/1000.0f);
